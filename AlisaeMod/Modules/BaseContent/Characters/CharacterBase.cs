...
namespace AlisaieMod.Modules.Characters
{
    ...
    public class BodyInfo
    {
        ...
        //stat growth
        /// <summary>
        /// Leave this alone, and 
        /// don't need to worry about setting any of the stat growth values. They'll be set at the consistent ratio that all vanilla survivors have.
